...
class Retriever():
    ...
    def __init__(self, retrieval_type="dense", document_store=None,
                 top_k=1, rerank_topk=1, score_threshold=0.8,
    ...
    def get_context(self, query):
        ...
        return context
    def get_context_with_keywords(self, keywords, query, malicious_injection):
        context = self.retriever.query_the_database_with_keywords(keywords, query, malicious_injection)
        return context